    ...
    {
        {
            ...
            builder.HasIndex(e => e.IdEmpleadoRepVentas, "id_empleado_rep_ventas");
            ...
            builder.Property(e => e.IdEmpleadoRepVentas).HasColumnName("id_empleado_rep_ventas");
            ...
            builder.HasOne(d => d.IdEmpleadoRepVentasNavigation).WithMany(p => p.Clientes)
                .HasForeignKey(d => d.IdEmpleadoRepVentas)
